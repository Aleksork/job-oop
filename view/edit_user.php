        ...
        <div class="edit-user">
            ...
            <div class="edit-user__cash">
                <div class="cash">
                    ...
                    <h3> <a class="btn" href="index.php?option=create_coof&id=<?=$text['0']['user_id'];?>">Изменить !!!</a></h3>
                </div>
            </div>
            ...
            <div class="edit-user__prem">
                <div class="title">
                    ...
                    </div><span> <a class="btn" href="index.php?option=create_prem&id=<?=$text['0']['user_id'];?>">Добавить </a></span>
                </div>
                <div class="table">
                    <table>
                        <thead>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?=$item['price'];?></td>
                                <td><?=$item['comment'];?></td>
                                <td> <a href="index.php?option=edit_prem&id=<?=$item['user_id'];?>&add=<?=$item['id'];?>">Редактировать</a></td>
                                <form method="POST" action="">
